...
checkpointpath="/media/airscan/Data/AIRSCAN/EE298F/dogbreed/inception_comp_weights/inception_weights_comp-{epoch:02d}.hdf5"
...
csv_logger = CSVLogger('training_inception_compl_dataset.log')
